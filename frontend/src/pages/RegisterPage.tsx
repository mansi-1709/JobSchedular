...
export function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await authService.register(name, email, password, orgName || undefined);
  ...
  return (
    <div className="card p-8 shadow-2xl">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400">Join JobScheduler to manage your tasks</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder={`${name ? name + "'s" : 'Your'} Organization`}
          />
        </div>
